    ...
    <div className="bg-gray-50 text-gray-800 flex items-center justify-center min-h-screen font-sans">
      <div className="w-full max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-gray-100">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 tracking-tight">PDF Query Assistant</h1>
          <p className="text-gray-500 mt-3 text-lg">Ask any question about the content of your PDF documents.</p>
        </div>
        ...
        {result && (
          <div className="mt-8 space-y-6 animate-fade-in">
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-5 shadow-sm">
              <h2 className="text-xl font-semibold text-indigo-800 mb-2">Answer</h2>
              <p className="text-indigo-900 leading-relaxed">{result.answer}</p>
            </div>
            {/* Reasoning Card */}
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 shadow-sm">
              <h2 className="text-xl font-semibold text-gray-800 mb-2">Reasoning</h2>
              <p className="text-gray-700 leading-relaxed">{result.reasoning}</p>
            </div>
            {/* Source Clause Card */}
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 shadow-sm">
              <h2 className="text-xl font-semibold text-gray-800 mb-2">Source Clause</h2>
              <p className="text-gray-600 text-sm leading-relaxed whitespace-pre-wrap font-mono bg-gray-100 p-3 rounded-md">{result.sourceClause}</p>
            </div>
          </div>
        )}
      </div>
